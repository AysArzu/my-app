...
export const Image = () => {
  return (
    <div>
        <h2>Static Images</h2>
        <p>Eger image ler public klasorunde ise ve herhangi bir optimizasyon gerekmiyorsa bu yontem kullanilir.</p>
      <img src="/vite.svg" alt="" />

      <h2>Dynamic Images</h2>
      <p>Eger image ler src klasorunde ise ve herhangi bir optimizasyon gerekiyorsa bu yontem kullanilir.</p>
