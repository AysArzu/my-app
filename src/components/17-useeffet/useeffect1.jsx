...
const Useeffect1 = () => {
    ...
    */
    ...
    useEffect(()=>{
        console.log("UPDATING-DA: Buradaki kodlar Dependecy Array icindeki degisken(ler)in degeri degistiginde calisir.")
    }, [error])
...
{showComp && <Useeffect2/>}
            ...
            <Button onClick={() => setShowComp((prev)=>!showComp)} className="mt-3">
               Toggle Comp
            </Button>
        </div>
    );
